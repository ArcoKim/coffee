        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between my-4">
                    <h1 class="h3 mb-0 text-gray-800">Shop - Remove</h1>
                </div>
                ...
                <div class="p-5 w-75 m-auto">
                    ...
                    <form class="user" action="/shop/process/delete.jsp" method="POST">
                        <div class="form-group">
                            ...
                            <div class="form-select">
                                <select name="scode" id="shop_select">
                                    ...
                                    <%
                                        Logger log = LoggerFactory.getLogger("/shop/remove.jsp");
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user"
                                   id="sname" placeholder="매장이름을 입력하세요." readonly>
                        </div>
