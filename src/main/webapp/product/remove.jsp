        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between my-4">
                    <h1 class="h3 mb-0 text-gray-800">Product - Remove</h1>
                </div>
                ...
                <div class="p-5 w-75 m-auto">
                    ...
                    <form class="user" action="/product/process/delete.jsp" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user"
                                   id="name" placeholder="상품이름을 입력하세요." readonly>
                        </div>
                        <div class="form-group">
                            <label for="cost">금액</label>
                            <input type="text" class="form-control form-control-user"
                                   id="cost" placeholder="금액을 입력하세요." readonly>
                        </div>
